...
let
  ...
  keystone-override = pkgs.keystone.overrideAttrs (old: {
    src = keystone-src;
  });
in
buildDotnetModule rec {
  ...
  meta = with lib; {
    ...
    description = "CLPS2C-Compiler is a compiler for CLPS2C, a domain-specific language built specifically for writing PS2 cheat codes";
